...
#		'small_print' : "'ACME AXE: Effective at dispatching small dragons, large crocodiles, and even the most agressive of trees.'",
		...
		'wear_hedgehog_broach' : "There's no sign of magical properties you're confident that Nana would be glad to have the broach worn about the castle again after all these years.",
