...
game_static_dict = {
	...
	#### STANDARD DICT ELEMENTS #### (see bottom too)
...
#        'open' : {('front_gate', None) : 5},
	...
	'royal_cypher' : "'WR'",
    'bold_script' : "The document boldly proclaims: 'On this day, the 22nd of September, 952 GUE, the mighty fortress of Bright Castle and all it's environs are formally decared to be free of the prenicious and dastardly presence of any and all Grues per the standard measures and specifications of the ISO 27017 certification!' (but in small text beneath this it continues: '...except that it be noted that, as per standard procedures, this inquiry excludes and does not extend to closets, cupboards, regions under stairs, basement rooms, tower chambers, dank dungeons, unlit hallways, or dark and shadowy facilities of any kind. If you come across any Grues in these areas, it's on you and we don't want to hear about it as we would never even think of venturing into such environs in the first place!')",

	### ViewOnly objects ###
	'dark_castle' : "Dark Castle looms over you. Its facade of blackened turrets and cracked battlements is dour and singlularly univiting and the sky above it foreboding and eternally overcast in dark storm clouds. It's hard to imagine but your great grandma Nana used to tell wonderous stories of the old days when the castle gleamed brightly on its hill and was a beacon of order and goodness for the land. Maybe it's because of the stories, but you've always had a bit of an itch to venture inside. The place has somehow called to you - almost daring you to enter... And now that a round of beer and your alehouse repuation as a fearless ruffian (and perhaps even the attentions of young miss Chrissy Brewer!) are on the line, you intend to answer the call!",		
...
#	'postbox' : "The Postbox is a small, rusty box with a slot for letters. It is covered in cobwebs and appears to have been unused for many years. You wonder if the Guard Goblin has any idea what it is doing here.",
	'alcove' : "A small indentation in the west wall near the iron portcullis. It is just deep enough to hold a guard goblin and a mysterious apparatus.",
...
#	'untrodden_path' : "The Untrodden Path is a narrow, winding trail that leads away from the castle and into the woods. It is overgrown with weeds and brambles, and it looks like it hasn't been used in years. You wonder where it leads and if it might be worth exploring.",
    ...
    'old_furniture' : "A jumble of rickety and dilapidated knick-knacks if ever you've seen one.",
	...
	'silver_key' : "The small Silver Key glitters in the dim light. It certainly stands out in the otherwise dreary Dark Castle. If you find a glittering silver keyhole somewhere this is definitely the key for it!",
...
#	'red_bandana' : "The ragged red bandana simultaneously projects juanty air of fluffy dog at the park - and also the rugged look of an 80s-era martial arts master ready for their final showdown.",
	'red_bandana' : "The ragged red bandana simultaneously projects juanty air of fluffy dog at the park - and also the rugged look of a legendary martial arts master ready for their final showdown.",
...
#	'antechamber' :"You are in a what feels more like a wide, tall-ceilinged corridor than a room. Apparently this is the room-before-the-room, the pre-room before the really, really grand room that comes after it. If so, the next room must be quite something because, back in it's day, this spot was clearly impressive. Alas, like all of the castle, it has fallen on dark times and now feels more sinister than grand. The east and west walls are bare stone. To the south is an open passageway leading to the Main Hall and to the north there is an Iron Portcullis that guards the path to the grand chamber beyond. Near the Iron Portcullis on the west wall there is a small Alcove. It appears to have some kind of apparatus in it but you can't see it very well due to the dim light and the Guard Goblin standing in front of it and glowering at you. The whole north end of the room is cloaked in shadows that make you uneasy.",
	...
	### warnings ###
    'entrance_south_warn_0' : "Don't be ridiculous Burt. You just swore to the whole pub (and to miss Chrissy Brewer too!) that you'd march into Dark Castle, grab the gold, and buy everyone drinks with it. That's why they gave you the rusty key. You can't turn back now!",
	'eat_biscuits_warning_1' : "You're tempted - this last biscuit smells delicious - but your great grandmother, Nana, who taught you her secret biscuit recipie in the first place, wouldn't abide by it. Nana always insisted that the last biscuit in a batch be given away. As a toddler you would howl that you wanted it more than anyone else in the world but Nana was firm. 'Charity and kindness are the secrect ingredients Burty' she would say. And she meant it. If there was no one handy to give the last biscuit to, she would place it out on the back step 'for a wee good-hearted animal'. But a Baker, she said, should never ever eat the last biscuit in a batch.",
...
#	'antechamber_with_panel' :"You are standing in a what feels more like a wide, tall-ceilinged corridor than a room. Apparently this is the room-before-the-room, the pre-room before the really, really grand room that comes after it. If so, the next room must be quite something because back in it's day this spot was clearly impressive. Alas, like all of the castle it has fallen on dark times and now feels more sinister than grand. The east and west walls are bare stone. To the south is an open passageway leading to the Main Hall and to the north there is an Iron Portcullis that guards the path to the grand chamber beyond. Near the Iron Portcullis on the west wall there is a small Alcove. It appears to have a Control Panel with some levers and a button on it.",
	...
	'antechamber_with_panel' :"You are standing in a what feels more like a wide, tall-ceilinged corridor than a room. Apparently this is the room-before-the-room, the pre-room before the really, really grand room that comes after it. If so, the next room must be quite something because back in it's day this spot was clearly impressive. Alas, like all of the castle it has fallen on dark times and now feels more sinister than grand. The east and west walls are bare stone with exits to the north and south. Near the north exit on the west wall there is a small alcove which contains a control panel.",
...
#		'hedgehog_guard_result' : "The moment you approach the Shiny Sword the territorial Royal Hedgehog springs forward, blocks your path, and bares it's Fierce Teeth.",
    ...
    'scroll_not_in_throne_result' : "Upon reading the Kinging Scroll aloud you hear a distant rumble as if great powers are at work... but then it fades... perhaps you need to read it from a seat of authority to complete the recipe?",
	...
	'big_rock_take_result2' : "Low and behold, when you lift the big rock a gleaming brass zorkmid is revealed! It must have been buried there for ages.",
