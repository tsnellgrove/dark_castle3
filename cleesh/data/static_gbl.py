...
engine_static_dict = {
	...
	'engine_version' : '3.8.0 build 0013 [12/11/2024])', # api.features.bug-fix (internal); was '3.86' until 6/12/2024
	...
	### help commands ###
	'help' : "Help syntax = 'help <option>'. Help options = 'basics', 'abbreviations', 'adjectives', 'articles', 'attack', 'creatures', 'command-queue', debug', 'multiples', 'one-word-commands', prepositions', 'read', 'save', 'travel', or 'verbs'.",
