...
# module description: class deffinition module for Creatures
...
class Creature(ViewOnly):
	...
	def get_inv_lst(self, gs):
		""" Returns the list of all accessable items in the accessable inventory of the methed-calling receptacle.
		"""
