...
- INPROC: combo Result cases (build 0008) []
	...
	- TBD: sort out TimerAndCreatureItemResult combo result
		- TBD: git branch for TimerAndCreatureItemResult_feature
			- TBD: 'git branch' to confirm *master
			- TBD: 'git branch TimerAndCreatureItemResult_feature' to create new branch
			- TBD: 'git branch' to confirm new branch exists but that master is still checked out
			- TBD: 'git checkout TimerAndCreatureItemResult_feature' to switch focus to branching_test branch
